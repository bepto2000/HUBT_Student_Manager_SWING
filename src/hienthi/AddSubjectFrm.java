...
public class AddSubjectFrm extends javax.swing.JDialog implements ActionListener {
    
    private HomeFrm homeFrm;
    private Subject subject;

    /**
     * Creates new form AddSubjectFrm
     */
    public AddSubjectFrm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSubjectFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddSubjectFrm dialog = new AddSubjectFrm(new javax.swing.JFrame(), true);
    ...
    private void clearData() {
        txtNumOfLesson.setText("");
        txtSubjectName.setText("");
        comboSubjectType.setSelectedIndex(0);
    }
    
    private void addNewSubject() {
        var id = txtSubjectId.getText();
        ...
        if (!id.isEmpty() && !name.isEmpty() && !lesson.isEmpty()) {
            subject.setKind(subjectType);
            subject.setName(name);
            subject.setNumOfLesson(Integer.parseInt(lesson));
            homeFrm.addNewSubjectCallback(subject);
